...
class Movies extends Component{
    ...
    renderMovie = ()=>{
        ...
        <>
                    ...
                    {showNoResult && 
                                            ...
                                            <p style={{color:'rgb(150, 147, 147)',fontSize:'20px'}}> No Movie Found <BiCameraMovie style={{fontSize:'20px'}} /> </p>
    ...
    fetchMovies = async ()=>{    
        ...
        const url=`https://www.omdbapi.com/?s=${search}&type=movie&apikey=c21e15c5`
            ...
            <div className="homePage">
                ...
                <div className="inputAndSearch">
                    <div className="inputSection">
                        <input placeholder="type to search movies " type="search" onChange={this.onSearch} value={search} className="searchMoviesAndSeries" />
                        <CiSearch />
                    </div>
